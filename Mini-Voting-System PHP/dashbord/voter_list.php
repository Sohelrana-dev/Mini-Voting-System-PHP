...
$voter_details = "SELECT * FROM voters WHERE deleted_at IS NULL";
...
<div class="col-8">
    <div class="card">
        <div class="card-header bg-blue-dark">
            <h2 class="text-white">Voter List</h2>
        </div>
        <div class="card-body">
                    ...
                    <table id="example3" class="display min-w850 dataTable no-footer" role="grid"
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="voter_full_preview.php?id=<?= $voter['id'];?>" title="full preview" class="btn btn-secondary shadow btn-xs sharp mr-1"><i
                                                class="fa fa-eye"></i></a>
                                        <a href="voter_edit.php?id=<?= $voter['id'];?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                        <a href="voter_delete.php?id=<?= $voter['id'];?>" class="btn btn-danger shadow btn-xs sharp"><i
