                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="commissioner/image/commissioner.png" alt="">
                                    <div class="header-info">
                                        <span class="text-black"><strong>COMMISSIONER</strong></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="../dashbord/logout.php" class="dropdown-item ai-icon">
                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="../dashbord.php" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="voter_trash_list.php">Voter Trash List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="../dashbord.php" aria-expanded="false">
                            <i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="candidate_trash_list.php">Candidate Trash List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="../dashbord.php" aria-expanded="false">
                            <i class="flaticon-381-networking"></i>
                            <span class="nav-text">Vote Result</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="vote_result.php.php">Vote Result</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
